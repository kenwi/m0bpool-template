...
{/literal}{/if}{literal}
  ...
  function refreshInformation(data) {
    ...
    storedPersonalSharerate.push(parseFloat(data.getdashboarddata.data.personal.sharerate * 60 * 60).toFixed(2))
  ...
  {/literal}{/if}{literal}
    ...
    $('#b-hashrate').html((number_format(data.getdashboarddata.data.personal.hashrate * 1000 * 60, 2)));
    $('#b-poolhashrate').html(number_format(data.getdashboarddata.data.pool.hashrate * 1000 * 60, 2));
    if (data.getdashboarddata.data.network.hashrate > 0) {
      $('#b-nethashrate').html(number_format(data.getdashboarddata.data.network.hashrate * 1000 * 60, 2));
    } else {
